...
export default defineComponent({
  name: 'AndroidstudioOriginalWordmarkIcon',
  props: {
    size: {
      type: [String, Number],
      default: '1em'
  ...
  render() {
	...
	<path d="M105.7 49.3h-8.9c-1.8 0-3.3 1.5-3.3 3.3-.1 1.8 1.3 3.2 3.1 3.3h9.2l-.1-6.6z" fill="#073042"/>
	<path d="M125.9 78.4H96.7c-1.8 0-3.3-1.5-3.3-3.3V52.5c0 1.8 1.4 3.3 3.3 3.3h24.4s4.8-.4 4.8 3.2v19.4z" fill="#4285F4"/>
	<path d="M112.3 66.8c1.3-1 1.6-2.8.6-4.1-.5-.7-1.4-1.1-2.3-1.2h.6v-1.8c0-.2-.1-.4-.3-.5-.3-.2-.6-.1-.8.2-.1.1-.1.2-.1.3v1.9c-1.6.2-2.7 1.8-2.5 3.4.1.8.5 1.5 1.2 1.9l-5.4 11.5h3.5l2.5-5.3c.3-.6 1.1-.9 1.7-.6.3.1.5.3.6.6l2.6 5.3h3.6l-5.5-11.6zm-1.8-.5c-1 0-1.8-.8-1.8-1.8s.8-1.8 1.8-1.8c.5 0 .9.2 1.2.5.7.7.7 1.9 0 2.6-.2.3-.7.5-1.2.5z" fill="#3870B2"/>
	<path d="M103.7 50.9h12.5v2.3h-12.5v-2.3z" fill="#FFF"/>
	<path d="M109.5 62.7c1 0 1.8.8 1.8 1.8s-.8 1.8-1.8 1.8-1.8-.8-1.8-1.8c0-.5.2-.9.5-1.3.4-.3.8-.5 1.3-.5zm.7-1.1v-1.9c0-.2-.1-.4-.3-.5-.3-.2-.6-.1-.8.2-.1.1-.1.2-.1.3v1.9c-1.6.2-2.7 1.8-2.5 3.4.1.8.5 1.5 1.2 1.9l-6.8 14.5c-.3.5-.2 1.1.1 1.6.5.7 1.5.9 2.2.4.2-.2.4-.4.6-.7l4.5-9.7c.3-.6 1.1-.9 1.7-.6.3.1.5.3.6.6l4.6 9.6c.4.8 1.3 1.1 2.1.7s1.1-1.3.7-2.1l-7-14.5c1.3-1 1.5-2.9.5-4.2-.1-.3-.6-.7-1.3-.9" fill="#073042"/>
	<path d="M114.4 52.9c-.5 0-.9-.4-.9-.8 0-.2.1-.5.3-.6.3-.3.9-.3 1.2 0 .2.2.2.4.3.6-.1.4-.4.8-.9.8m-9.4 0c-.5 0-.9-.4-.9-.8 0-.2.1-.5.3-.6.3-.4.8-.4 1.2-.1.4.3.4.9.1 1.2l-.1.1c-.2.1-.4.2-.6.2m9.7-5.1l1.7-2.9c.1-.2 0-.4-.1-.5-.1-.1-.3 0-.4.1l-1.8 3c-2.8-1.2-6-1.2-8.7 0l-1.7-3c-.1-.1-.2-.2-.3-.2-.1 0-.2.1-.3.2-.1.1-.1.2 0 .4l1.7 2.9c-3 1.6-4.9 4.7-5.2 8H120c-.4-3.4-2.3-6.4-5.3-8" fill="#3DDC84"/>
	<path d="M123 62.1h-1.3c-.1 0-.1.1-.1.2v21.2c0 .1.1.2.2.2h1.4c1.6 0 2.9-1.3 2.9-2.9V59.1c-.1 1.7-1.4 3-3.1 3z" fill="#073042"/>
</svg>;
  }
});