...
export default defineComponent({
  name: 'ThealgorithmsPlainWordmarkIcon',
  props: {
    size: {
      type: [String, Number],
      default: '1em'
  ...
  render() {
    ...
    return <svg {...props} id="thealgorithms-plain-wordmark-Layer_1" version="1.1" viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg" xmlSpace="preserve">
