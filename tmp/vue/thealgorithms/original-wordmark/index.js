...
export default defineComponent({
  name: 'ThealgorithmsOriginalWordmarkIcon',
  props: {
    size: {
      type: [String, Number],
      default: '1em'
