...
export default defineComponent({
  ...
  render() {
	...
	<path d="M23.188.019 114.438 20h9.874v108h-103.5a6.5 6.5 0 0 1-6.5-6.5V94.287L22.996.3Z" fill="#36697f"/>
	<path d="M23.188 0h85.75a6.5 6.5 0 0 1 6.5 6.5V90h-92.25z" fill="#37a5cc"/>
	<path d="M23.188 90V0l-19.5 11.75v90z" fill="#7dc6dd"/>
