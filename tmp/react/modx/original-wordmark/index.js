...
module.exports = function ModxOriginalWordmarkIcon({size = "1em",  ...props}){
  props = {
    ...props,
    style: {
  ...
  return (<svg {...props} viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg">
	<path className="modx-original-wordmark-st0" d="M92.1 40.8l18.3-29.3h-44l-6.1 9.8z" fill="#00b5de"/>
	<path className="modx-original-wordmark-st2" d="M101.8 93.8v-44l-9.5-5.9-20 31.5z" fill="#ff5529"/>
	<path className="modx-original-wordmark-st3" d="M30.9 2.7v44l10.2 5.9 51-11.8z" fill="#00decc"/>
	<path className="modx-original-wordmark-st4" d="M40.9 56L22.6 84.8h44l25.7-40.9z" fill="#ff9640"/>
	<g fill="#102c53">
