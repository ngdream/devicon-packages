...
module.exports = function JetbrainsOriginalIcon({size = "1em",  ...props}){
  props = {
    ...props,
    style: {
  ...
  return (<svg {...props} viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg">
	<defs>
		<linearGradient id="jetbrains-original-a" gradientTransform="scale(.71111)" gradientUnits="userSpaceOnUse" x1="32.64" x2="82.77" y1="61.16" y2="85.54">
			<stop offset=".21" stopColor="#fe2857"/>
			<stop offset="1" stopColor="#293896"/>
		</linearGradient>
		<linearGradient id="jetbrains-original-b" gradientTransform="scale(.71111)" gradientUnits="userSpaceOnUse" x1="17.38" x2="82.95" y1="69.86" y2="21.23">
			<stop offset="0" stopColor="#fe2857"/>
			<stop offset=".01" stopColor="#fe2857"/>
			<stop offset=".86" stopColor="#ff318c"/>
		</linearGradient>
		<linearGradient id="jetbrains-original-c" gradientTransform="scale(.71111)" gradientUnits="userSpaceOnUse" x1="74.17" x2="160.27" y1="21.58" y2="99.76">
			<stop offset=".02" stopColor="#ff318c"/>
			<stop offset=".21" stopColor="#fe2857"/>
			<stop offset=".86" stopColor="#fdb60d"/>
		</linearGradient>
		<linearGradient id="jetbrains-original-d" gradientTransform="scale(.71111)" gradientUnits="userSpaceOnUse" x1="155.46" x2="55.07" y1="89.8" y2="158.9">
