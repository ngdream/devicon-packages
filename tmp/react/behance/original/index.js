...
module.exports = function BehanceOriginalIcon({size = "1em",  ...props}){
  props = {
    ...props,
    style: {
  ...
  return (<svg {...props} viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg">
	<defs>
		<linearGradient id="behance-original-a" gradientUnits="userSpaceOnUse" x1="64" x2="64" y1="2.16" y2="125.84">
			<stop offset="0" stopColor="#005cff"/>
			<stop offset="1" stopColor="#0047ad"/>
		</linearGradient>
	</defs>
	<rect height="123.67" width="123.68" fill="url(#behance-original-a)" rx="14.59" ry="14.59" x="2.16" y="2.16"/>
