...
module.exports = function WeblateOriginalIcon({size = "1em",  ...props}){
  props = {
    ...props,
    style: {
  ...
  return (<svg {...props} viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg">
	<g transform="translate(50 76)">
		<linearGradient id="weblate-original-a" gradientTransform="matrix(.9831 0 0 -1.0172 49.154 52.895)" gradientUnits="userSpaceOnUse" x1="-100.86" x2="-37.246" y1="63.797" y2="63.797">
			<stop offset="0" stopColor="#00d2e6"/>
			<stop offset="1" stopColor="#2eccaa"/>
		</linearGradient>
		<linearGradient id="weblate-original-b" gradientTransform="matrix(1.1631 0 0 -.8598 58.153 44.71)" gradientUnits="userSpaceOnUse" x1="-59.46" x2="-26.638" y1="27.873" y2="43.338">
			<stop offset="0" stopOpacity="0"/>
			<stop offset=".514"/>
			<stop offset="1" stopOpacity="0"/>
		</linearGradient>
		<linearGradient id="weblate-original-c" gradientTransform="matrix(.9831 0 0 -1.0172 49.154 52.895)" gradientUnits="userSpaceOnUse" x1="29.342" x2="-34.164" y1="63.797" y2="63.797">
		...
		<path d="M32 12.5c-1.9 0-3.7-.4-5.5-1.2-4-1.7-7.4-5-10.3-9.4.8-1.4 1.5-2.9 2.2-4.4.9-2 1.6-4 2.2-6.1C22-13.4 40.2-7.3 37.5.7 36 4.8 34.2 8.8 32 12.5zM9.8 32.7c-9.3 3.8-20.2 3.6-29.4-.7-10.6-4.9.3-21.5 6.4-18.1 2.2 1.2 4.5 2 7 2.3 4.3 6.8 9.8 12.5 16 16.5z" fill="url(#weblate-original-b)" fillRule="evenodd" opacity=".3"/>
