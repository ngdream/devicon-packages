...
module.exports = function KdeneonOriginalIcon({size = "1em",  ...props}){
  props = {
    ...props,
    style: {
  ...
  return (<svg {...props} viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg">
	<defs>
		<linearGradient id="prefix__g" gradientTransform="translate(0 -2678.3) scale(2.66667)" gradientUnits="userSpaceOnUse" x1="25" x2="25" y1="1004.362" y2="1052.362">
			<stop offset="0" stopColor="#1abc9c"/>
			<stop offset="1" stopColor="#2980b9"/>
		</linearGradient>
		<linearGradient id="prefix__b" gradientTransform="rotate(45 4083.407 1707.592) scale(3.29412)" gradientUnits="userSpaceOnUse" x1="24" x2="49" y1="1028.362" y2="1028.362">
			<stop offset="0"/>
			<stop offset="1" stopOpacity="0"/>
		</linearGradient>
		<linearGradient id="prefix__d" gradientTransform="rotate(45 11494.91 4777.53) scale(3.29412 9.26466)" gradientUnits="userSpaceOnUse" x1="24" x2="49" y1="1028.362" y2="1028.362">
			<stop offset="0"/>
			<stop offset="1" stopOpacity="0"/>
		</linearGradient>
		<linearGradient id="prefix__f" gradientTransform="rotate(45 17372.966 7212.296) scale(3.29412 13.99989)" gradientUnits="userSpaceOnUse" x1="24" x2="49" y1="1028.362" y2="1028.362">
			<stop offset="0"/>
			<stop offset="1" stopOpacity="0"/>
		</linearGradient>
		...
		<g id="prefix__h" clipPath="url(#prefix__a)">
			<path d="M73.316 54.684L54.684 73.316l44.27 44.266a63.975 63.975 0 0018.609-18.656zm0 0" fill="url(#prefix__b)" fillRule="evenodd"/>
		</g>
		<g id="prefix__i" clipPath="url(#prefix__c)">
			<path d="M90.203 37.797l-1.176 1.176A35.422 35.422 0 0199.41 64c0 19.559-15.851 35.41-35.41 35.41a35.422 35.422 0 01-25.027-10.383l-1.176 1.176 36.887 36.89c26.832-4.573 47.84-25.62 52.359-52.464zm0 0" fill="url(#prefix__d)" fillRule="evenodd"/>
		</g>
		<g id="prefix__j" clipPath="url(#prefix__e)">
			<path d="M103.598 24.39v.012l-3.078 3.078A51.647 51.647 0 01115.676 64c0 28.54-23.137 51.676-51.676 51.676a51.667 51.667 0 01-36.52-15.16l-3.078 3.082 21.832 21.836A64.06 64.06 0 0064 128c35.348 0 64-28.652 64-64a64.071 64.071 0 00-2.543-17.75zm0 0" fill="url(#prefix__f)" fillRule="evenodd"/>
		</g>
	</defs>
	<path d="M128 64c0 35.348-28.652 64-64 64S0 99.348 0 64 28.652 0 64 0s64 28.652 64 64zm0 0" fill="url(#prefix__g)" fillRule="evenodd"/>
	...
	<g clipPath="url(#prefix__a)" opacity=".2">
		<path d="M73.316 54.684L54.684 73.316l44.27 44.266a63.975 63.975 0 0018.609-18.656zm0 0" fill="url(#prefix__b)" fillRule="evenodd"/>
	</g>
	<g clipPath="url(#prefix__c)" opacity=".2">
		<path d="M90.203 37.797l-1.176 1.176A35.422 35.422 0 0199.41 64c0 19.559-15.851 35.41-35.41 35.41a35.422 35.422 0 01-25.027-10.383l-1.176 1.176 36.887 36.89c26.832-4.573 47.84-25.62 52.359-52.464zm0 0" fill="url(#prefix__d)" fillRule="evenodd"/>
	</g>
	<g clipPath="url(#prefix__e)" opacity=".2">
		<path d="M103.598 24.39v.012l-3.078 3.078A51.647 51.647 0 01115.676 64c0 28.54-23.137 51.676-51.676 51.676a51.667 51.667 0 01-36.52-15.16l-3.078 3.082 21.832 21.836A64.06 64.06 0 0064 128c35.348 0 64-28.652 64-64a64.071 64.071 0 00-2.543-17.75zm0 0" fill="url(#prefix__f)" fillRule="evenodd"/>
	</g>
</svg>);
}